...
#line 29 "/Users/saitadikonda/Desktop/TestingFolder/PyQt4_gpl_mac-4.12/QtGui/sipQtGuiQStyleHintReturn.cpp"
...
static sipEnumMemberDef enummembers_QStyleHintReturn[] = {
    {sipName_SH_Default, static_cast<int>( ::QStyleHintReturn::SH_Default), 491},
    {sipName_SH_Mask, static_cast<int>( ::QStyleHintReturn::SH_Mask), 491},
    {sipName_SH_Variant, static_cast<int>( ::QStyleHintReturn::SH_Variant), 491},
    {sipName_Type, static_cast<int>( ::QStyleHintReturn::Type), 492},
    {sipName_Version, static_cast<int>( ::QStyleHintReturn::Version), 493},
};
...
static pyqt4ClassPluginDef plugin_QStyleHintReturn = {
    0,
    0,
    0
};
...
sipClassTypeDef sipTypeDef_QtGui_QStyleHintReturn = {
    {
        -1,
        0,
        0,
