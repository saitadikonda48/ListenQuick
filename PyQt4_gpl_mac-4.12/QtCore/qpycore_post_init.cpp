...
#if PY_MAJOR_VERSION >= 3
    PyObject *sip_flags = PyUnicode_FromString("-x VendorID -t WS_MACX -t Qt_4_8_7 -x Py_v3");
#else
    PyObject *sip_flags = PyString_FromString("-x VendorID -t WS_MACX -t Qt_4_8_7 -x Py_v3");
#endif
