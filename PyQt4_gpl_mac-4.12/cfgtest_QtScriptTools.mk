...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Mon Jan 16 03:14:08 2017
# Project:  cfgtest_QtScriptTools.pro
# Template: app
# Command: /opt/local/bin/qmake -spec /opt/local/share/qt4/mkspecs/macx-g++ -o cfgtest_QtScriptTools.mk cfgtest_QtScriptTools.pro
#############################################################################
...
INCPATH       = -I/opt/local/share/qt4/mkspecs/macx-g++ -I. -I. -I/opt/local/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtScriptTools.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtScript.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtScript.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtScriptTools.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/opt/local/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/opt/local/include -F/opt/local/Library/Frameworks -F/opt/local/lib
LINK          = /usr/bin/clang++
LFLAGS        = -headerpad_max_install_names -arch x86_64 -Xarch_x86_64 -mmacosx-version-min=10.10
LIBS          = $(SUBLIBS) -F/opt/local/Library/Frameworks -F/opt/local/lib  -F/opt/local/Library/Frameworks -F/opt/local/lib -L/opt/local/lib -framework QtScript -framework QtCore -framework QtScriptTools -framework QtGui 
AR            = ar cq
RANLIB        = ranlib -s
...
cfgtest_QtScriptTools.mk: cfgtest_QtScriptTools.pro  /opt/local/share/qt4/mkspecs/macx-g++/qmake.conf /opt/local/share/qt4/mkspecs/common/unix.conf \
		/opt/local/share/qt4/mkspecs/common/mac.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base.conf \
		/opt/local/share/qt4/mkspecs/common/gcc-base-macx.conf \
		/opt/local/share/qt4/mkspecs/common/g++-base.conf \
		...
		/opt/local/Library/Frameworks/QtScriptTools.framework/QtScriptTools.prl \
		/opt/local/Library/Frameworks/QtGui.framework/QtGui.prl
	$(QMAKE) -spec /opt/local/share/qt4/mkspecs/macx-g++ -o cfgtest_QtScriptTools.mk cfgtest_QtScriptTools.pro
...
cfgtest_QtScriptTools.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,cfgtest_QtScriptTools,g" -e "s,@TYPEINFO@,????,g" /opt/local/share/qt4/mkspecs/macx-g++/Info.plist.app >cfgtest_QtScriptTools.app/Contents/Info.plist
dist: 
